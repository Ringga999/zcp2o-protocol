...
> 
> Alpha Drop is a top-down 2D action game developed in Godot Engine. It serves as the primary proof-of-concept for the ZCP2O "Proof-of-Play" consensus mechanism, demonstrating how players can earn $ZPRO tokens through real gameplay in an offline/local mesh environment.

---

## 🌟 Key Features

*   **Zero-Capital Entry:** Players can start playing and earning $ZPRO without buying any initial tokens.
...
*   **Implicit Anti-Bot System:** Integrated behavioral biometrics and diminishing returns to ensure fair distribution of $ZPRO to real human players.
